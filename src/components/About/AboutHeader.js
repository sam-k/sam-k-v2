        ...
        return (
            <div id='about-header'>
                <div id='about-header-wrapper'>
                    <h1>Bio</h1>
                    <p id='desc'>I’m currently a senior at Duke University and an incoming software developer intern at <a href="https://www.epic.com/"><span className='code'>Epic</span> <span className='code'>Systems</span></a>, technology for health-care providers.</p>
