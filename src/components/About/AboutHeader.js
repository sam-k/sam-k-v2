    ...
    return (
      <div id='about-header'>
        <div id='about-header-wrapper'>
          <h1>Bio</h1>
          <p id='desc'>I’m currently a senior at <span className="code" style={{ color: "#00539b" }}>Duke</span> <span className="code" style={{ color: "#00539b" }}>University</span>, studying biology and computer science.</p>
